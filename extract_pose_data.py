...
Output: CSV, JSON (array of row objects), or Excel with columns [frame, label, lm_0_x, ...] for training.
...
Keys:
  U - Charge stance (label: charge_stance)
  I - Transition (label: transition)
  O - Elbow strike final position (label: elbowstrikefinalposition)
...
def run(video_path: str, output_path: str, speed: float = 1.0, portrait: bool = True, max_height: int = 640) -> None:
    ...
    print("Keys: U=charge_stance, I=transition, O=elbowstrikefinalposition, G=good_rep, P=positive, N=bad, Space=pause, Q=quit & save")
    print("When you see the pose you want (charge_stance, transition, or elbowstrikefinalposition), press its key to save that frame's pose.\n")
